  ...
  return (
    <main className="signin-page">
      <article className="signin-container">
        ...
        {/* Left branding panel */}
        <aside className="signin-left-panel" aria-label="About Municipal Connect">
          ...
          <small className="signin-ward">Ward 58 · City of Johannesburg</small>
        </aside>

        {/* Right form panel */}
        <section className="signin-form-panel" aria-label="Sign in form">
          <header>
            <h2>Welcome back</h2>
          ...
          <form onSubmit={handleEmailSignIn} className="signin-form" noValidate>
            <fieldset>
          ...
          <button className="google-btn" onClick={handleGoogleSignIn} disabled={loading} aria-label="Sign in with Google">
          ...
          <aside className="staff-note" aria-label="Staff information">
