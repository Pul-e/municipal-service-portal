    ...
    useEffect(() => {
        async function fetchRequestDetails() {
            ...
            try {
                ...
                // ── CHANGED: fetch most recent assignment (includes image_url) ──
                // We order by assigned_at DESC and take the latest row so we still
                // see the resolution photo even after unassigned_at has been set.
